...
\texttt{\textbackslash photos} & \photos & \texttt{\textbackslash powheg} & \powheg & \texttt{\textbackslash pythia} & \pythia \\
\texttt{\textbackslash resbos} & \resbos & \texttt{\textbackslash roofit} & \roofit & \texttt{\textbackslash root} & \root \\
\texttt{\textbackslash spice} & \spice & \texttt{\textbackslash urania} & \urania &  \\
\end{tabular*}
